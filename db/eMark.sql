...
CREATE TABLE IF NOT EXISTS `eMark`.`Itens_Vendas` (
  ...
  `Financeiro_Entrada_idFinanceiro_Entrada` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eMark`.`Financeiro_Entrada` (
  ...
  `Id_FinanceiroCaixa` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Tabela .`FormasDePagamento_has_Vendas`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Tabela .`Produtos_has_Itens_Vendas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eMark`.`Produtos_has_Itens_Vendas` (
  `Produtos_id` INT NOT NULL,
  `Itens_Vendas_id` INT NOT NULL,
  PRIMARY KEY (`Produtos_id`, `Itens_Vendas_id`),
  INDEX `fk_Produtos_has_Itens_Vendas_Itens_Vendas1_idx` (`Itens_Vendas_id` ASC),
  INDEX `fk_Produtos_has_Itens_Vendas_Produtos1_idx` (`Produtos_id` ASC),
  CONSTRAINT `fk_Produtos_has_Itens_Vendas_Produtos1`
    FOREIGN KEY (`Produtos_id`)
    REFERENCES `eMark`.`Produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Produtos_has_Itens_Vendas_Itens_Vendas1`
    FOREIGN KEY (`Itens_Vendas_id`)
    REFERENCES `eMark`.`Itens_Vendas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Tabela .`Itens_Compra_has_Produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eMark`.`Itens_Compra_has_Produtos` (
  `Itens_Compra_id` INT NOT NULL,
  `Produtos_id` INT NOT NULL,
  PRIMARY KEY (`Itens_Compra_id`, `Produtos_id`),
  INDEX `fk_Itens_Compra_has_Produtos_Produtos1_idx` (`Produtos_id` ASC),
  INDEX `fk_Itens_Compra_has_Produtos_Itens_Compra1_idx` (`Itens_Compra_id` ASC),
  CONSTRAINT `fk_Itens_Compra_has_Produtos_Itens_Compra1`
    FOREIGN KEY (`Itens_Compra_id`)
    REFERENCES `eMark`.`Itens_Compra` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Itens_Compra_has_Produtos_Produtos1`
    FOREIGN KEY (`Produtos_id`)
    REFERENCES `eMark`.`Produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
