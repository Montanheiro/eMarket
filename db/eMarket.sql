...
-- -----------------------------------------------------
-- Table `eMarket`.`compra_formapagamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eMarket`.`compra_formapagamento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Compras_id` INT NOT NULL,
  `FormasDePagamento_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `eMarket`.`venda_formapagamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eMarket`.`venda_formapagamento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Vendas_id` INT NOT NULL,
  `FormasDePagamento_id` INT NOT NULL,
